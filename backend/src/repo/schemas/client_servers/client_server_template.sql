...
-- 2) Use the newly-created schema for the rest of this script, ensuring public is also in path
SET search_path TO client_template, public;

-- 3) Enable extension(s) first to make functions available (e.g., in public schema)
